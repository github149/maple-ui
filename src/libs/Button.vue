<template>
  <button class="maple-btn" :class="type">
    <slot />
  </button>
</template>
<script>
...
export default {
  ...
  setup(props) {
    let type = computed(() => `maple-btn-${props.type}`);
    return {
      props,
      type,
    };
