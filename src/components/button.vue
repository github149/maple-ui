  ...
  <div class="button">
    <div class="mt-40">
      ...
      <div class="demo">
        ...
        <div class="demo-actions">
          <Button v-if='btn1visible' @click="btn1visible = !btn1visible">查看代码</Button>
    ...
    <div class="mt-40">
      ...
      <div class="demo">
        ...
        <div class="demo-actions">
          <Button v-if='btn2visible' @click="btn2visible = !btn2visible">查看代码</Button>
    ...
    <div class="mt-40">
      ...
      <div class="demo">
        ...
        <div class="demo-actions">
          <Button v-if='btn3visible' @click="btn3visible = !btn3visible">查看代码</Button>
    ...
    <div class="mt-40">
      ...
      <div class="demo">
        ...
        <div class="demo-actions">
          <Button v-if='btn4visible' @click="btn4visible = !btn4visible">查看代码</Button>
